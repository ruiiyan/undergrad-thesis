...
Use the following grade descriptors as calibration for cognitive depth. Higher grades correspond to higher Bloom levels:

| Grade Band             | Descriptor                                                                                   | Expected Bloom Level |
| ---------------------- | -------------------------------------------------------------------------------------------- | -------------------- |
| Fail (0–49)            | Insignificant description of events. Unable to examine or articulate learning.               | 1                    |
| Pass (50–64)           | Adequate description of events. Surface level analysis only. Learning not well articulated.  | 2                    |
| Credit (65–74)         | Detailed description. Significant level of analysis. Able to articulate learning succinctly. | 3–4                  |
| Distinction (75–84)    | Excellent description. Deep analysis of learning experience. Learning concisely articulated. | 5                    |
| High Distinction (85+) | Excellent description. Insightful analysis. Learning well articulated. Exemplary work.       | 6                    |
